  ...
  await Navigator.of(context).push<void>(
    MaterialPageRoute<void>(
      ...
      builder: (BuildContext context) =>
          _AttachmentMobileFullscreenVideoPage(attachment: attachment),
    ),
  );
}

class _AttachmentMobileFullscreenVideoPage extends StatefulWidget {
  const _AttachmentMobileFullscreenVideoPage({required this.attachment});

  final Attachment attachment;

  @override
  State<_AttachmentMobileFullscreenVideoPage> createState() =>
      _AttachmentMobileFullscreenVideoPageState();
}
