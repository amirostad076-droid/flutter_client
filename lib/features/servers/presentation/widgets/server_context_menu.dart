...
Future<ServerAction?> showServerContextMenu(
  ...
  final result =
      await Navigator.of(context).push<ServerAction>(
        _ServerContextMenuRoute(
          position: local,
...
class _ServerContextMenuRoute extends PopupRoute<ServerAction> {
    ...
    return [
      if (hasUnread)
        _MenuItem(
          ...
          onTap: () => pop(ServerAction.markAsRead),
        ),
      ...
      _MenuItem(
        ...
        onTap: () => pop(ServerAction.muteToggle),
      ),
      const _MenuDivider(),
      _MenuItem(
        ...
        isDanger: true,
        onTap: () => pop(ServerAction.leaveServer),
      ),
      const _MenuDivider(),
      _MenuItem(
        label: 'Copy Community ID',
        icon: PhosphorIconsRegular.hash,
        onTap: () => pop(ServerAction.copyServerId),
      ),
    ];
  }
}
